...
public class ReflectUtils {
     ...
     * 获取相对属性该方法的值
     * @author JohnDeng
     * @datatime 2018年9月12日下午6:31:08
     * @param object
     * @param field
     * @return
     */
    public static Object getMethodValue(Object object, Field field) {
		Object value = null;
		try {
			Method method = ReflectUtils.getClass(object).getMethod(MyBeanUtils.getMethodName(field.getName()));
